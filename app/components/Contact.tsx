  ...
  return (
    <div className="fixed inset-0 z-25 overflow-y-auto ">
      <div ref={containerRef} className="relative min-h-screen">
        ...
        {/* Footer */}
        <div className="fixed bottom-0 left-0 right-0 z-30 px-6 md:px-16 pb-4 md:pb-8 bg-black/80 lg:bg-transparent backdrop-blur-md lg:backdrop-blur-none border-t border-white/10 lg:border-none pt-2 lg:pt-0">
          <div className="flex flex-col-reverse lg:flex-row justify-between items-center lg:items-end gap-4 lg:gap-0">
            {/* Footer gauche - Copyright */}
            <div className="text-white text-[10px] md:text-xs opacity-80 text-center lg:text-left" style={{ fontFamily: 'Satoshi, sans-serif' }}>
              <p>
                © 2025 | Dev by{' '}
                <a
