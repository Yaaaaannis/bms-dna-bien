  ...
  return (
    <div className="fixed inset-0 z-25 overflow-y-auto ">
      <div ref={containerRef} className="relative min-h-screen">
        ...
        <div className="w-[75%] min-h-screen flex flex-col pt-52 pb-32 px-64">
          {/* Titre */}
          ...
          {/* Formulaire */}
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-8 max-w-3xl ml-32">
            {/* Première ligne : NOM et PRÉNOM côte à côte */}
            <div className="grid grid-cols-2 gap-8">
              <div className="flex flex-col field-container">
                <label 
                  htmlFor="nom"
                  className="text-white text-sm uppercase tracking-wider mb-2"
        ...
        {/* Footer */}
        <div className="fixed bottom-0 left-0 right-0 z-30 px-16 pb-8">
          <div className="flex justify-between items-end">
            {/* Footer gauche - Copyright */}
            <div className="text-white text-xs opacity-80" style={{ fontFamily: 'Satoshi, sans-serif' }}>
              <p>
                © 2025 | Dev by{' '}
                <a 
